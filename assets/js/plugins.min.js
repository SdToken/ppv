...
function countDown() {
    ...
    setInterval(function() {
        var e = (new Date).getTime()
          , t = i - e;
        document.getElementById("days") && (document.getElementById("days").innerText = addZero(Math.floor(t / 864e5)),
...
!function(e, t) {
    ...
    var p = function(i) {
        var e, p, w, r, o, h, u, g, x, l, c, _, k, s, T, v, a, d, m, S = "sizzle" + 1 * new Date, y = i.document, E = 0, n = 0, f = se(), b = se(), C = se(), A = function(e, t) {
            return e === t && (c = !0),
            0
        }, O = {}.hasOwnProperty, t = [], D = t.pop, N = t.push, L = t.push, I = t.slice, j = function(e, t) {
            for (var i = 0, n = e.length; i < n; i++)
                if (e[i] === t)
                    return i;
            return -1
        }, $ = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", P = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", H = "\\[" + M + "*(" + P + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + P + "))|)" + M + "*\\]", q = ":(" + P + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + H + ")*)|.*)\\)|)", W = new RegExp(M + "+","g"), R = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$","g"), F = new RegExp("^" + M + "*," + M + "*"), z = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), B = new RegExp("=" + M + "*([^\\]'\"]*?)" + M + "*\\]","g"), U = new RegExp(q), V = new RegExp("^" + P + "$"), Y = {
            ID: new RegExp("^#(" + P + ")"),
            CLASS: new RegExp("^\\.(" + P + ")"),
            TAG: new RegExp("^(" + P + "|[*])"),
            ATTR: new RegExp("^" + H),
        ...
        }, X = /^(?:input|select|textarea|button)$/i, Q = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/, G = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, Z = /[+~]/, J = new RegExp("\\\\([\\da-f]{1,6}" + M + "?|(" + M + ")|.)","ig"), ee = function(e, t, i) {
            var n = "0x" + t - 65536;
        ...
        function re(e, t, i, n) {
            var o, r, s, a, l, c, d, u = t && t.ownerDocument, f = t ? t.nodeType : 9;
            if (i = i || [],
        ...
        (w = re.selectors = {
            ...
            filter: {
                ...
                CHILD: function(h, e, t, g, v) {
                    ...
                    : function(e, t, i) {
                        var n, o, r, s, a, l, c = m !== y ? "nextSibling" : "previousSibling", d = e.parentNode, u = b && e.nodeName.toLowerCase(), f = !i && !b, p = !1;
                        if (d) {
                            if (m) {
                                for (; c; ) {
                                    for (s = e; s = s[c]; )
                            ...
                            } else if (f && (p = a = (n = (o = (r = (s = e)[S] || (s[S] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[h] || [])[0] === E && n[1]),
                            !1 === p)
                                for (; (s = ++a && s && s[c] || (p = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== u : 1 !== s.nodeType) || !++p || (f && ((o = (r = s[S] || (s[S] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[h] = [E, p]),
                                s !== e)); )
                                    ;
            ...
            ae(function(e, t, i, n) {
                var o, r, s, a = [], l = [], c = t.length, d = e || function(e, t, i) {
                    for (var n = 0, o = t.length; n < o; n++)
                        re(e, t[n], i);
                    return i
                }(h || "*", i.nodeType ? [i] : i, []), u = !p || !e && h ? d : we(d, a, p, i, n), f = g ? m || (e ? p : c || v) ? [] : t : u;
                if (g && g(u, f, i, n),
                v)
                    for (o = we(f, l),
                    v(o, [], i, n),
        ...
        u = re.compile = function(e, t) {
            ...
            if (!s) {
                ...
                n = function(e, t, i, n, o) {
                    var r, s, a, l = 0, c = "0", d = e && [], u = [], f = x, p = e || b && w.find.TAG("*", o), h = E += null == f ? 1 : Math.random() || .1, g = p.length;
    ...
    function re(e, t, i, n) {
        ...
        , l = a(), c = i && i[3] || (S.cssNumber[t] ? "" : "px"), d = (S.cssNumber[t] || "px" !== c && +l) && te.exec(S.css(e, t));
        if (d && d[3] !== c) {
            for (l /= 2,
            c = c || d[3],
            d = +l || 1; s--; )
    ...
    S.event = {
            ...
            if (v && (l = v.events)) {
                for (c = (t = (t || "").match($) || [""]).length; c--; )
                    ...
                    p) {
                        ...
                        s = r = f.length; r--; )
                            d = f[r],
                            !o && g !== d.origType || i && i.guid !== d.guid || a && !a.test(d.namespace) || n && n !== d.selector && ("**" !== n || !d.selector) || (f.splice(r, 1),
        ...
        dispatch: function(e) {
            var t, i, n, o, r, s, a = S.event.fix(e), l = new Array(arguments.length), c = (Q.get(this, "events") || {})[a.type] || [], d = S.event.special[a.type] || {};
            for (l[0] = a,
    ...
    function je(i, n, o, r) {
        n = g.apply([], n);
        var e, t, s, a, l, c, d = 0, u = i.length, f = u - 1, p = n[0], h = y(p);
    ...
    S.extend({
        ...
        clone: function(e, t, i) {
            var n, o, r, s, a, l, c, d = e.cloneNode(!0), u = S.contains(e.ownerDocument, e);
    ...
    function qe(e, t, i) {
        ...
        return (i = i || Pe(e)) && ("" !== (s = i.getPropertyValue(t) || i[t]) || S.contains(e.ownerDocument, e) || (s = S.style(e, t)),
        !m.pixelBoxStyles() && Me.test(s) && He.test(t) && (n = a.width,
        o = a.minWidth,
        r = a.maxWidth,
    ...
    S.extend({
        ...
        style: function(e, t, i, n) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, s, a = V(t), l = Fe.test(t), c = e.style;
                if (l || (t = Ye(a)),
    ...
    S.each(["height", "width"], function(e, a) {
        S.cssHooks[a] = {
            ...
            set: function(e, t, i) {
                var n, o = Pe(e), r = "border-box" === S.css(e, "boxSizing", !1, o), s = i && Qe(e, a, i, r, o);
    ...
    function lt(r, e, t) {
        var i, s, n = 0, o = lt.prefilters.length, a = S.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (s)
                return !1;
    ...
    S.Animation = S.extend(lt, {
        ...
        tweener: function(e, t) {
            ...
            ["*"]) : e.match($)).length; n < o; n++)
                i = e[n],
                lt.tweeners[i] = lt.tweeners[i] || [],
                lt.tweeners[i].unshift(t)
        },
        prefilters: [function(e, t, i) {
            var n, o, r, s, a, l, c, d, u = "width"in t || "height"in t, f = this, p = {}, h = e.style, g = e.nodeType && ne(e), v = Q.get(e, "fxshow");
    ...
    S.fn.extend({
        ...
        finish: function(s) {
            return !1 !== s && (s = s || "fx"),
            this.each(function() {
                var e, t = Q.get(this), i = t[s + "queue"], n = t[s + "queueHooks"], o = S.timers, r = i ? i.length : 0;
                for (t.finish = !0,
                S.queue(this, s, []),
    ...
    S.extend(S.event, {
        trigger: function(e, t, i, n) {
            var o, r, s, a, l, c, d, u, f = [i || T], p = v.call(e, "type") ? e.type : e, h = v.call(e, "namespace") ? e.namespace.split(".") : [];
            if (r = u = s = i = i || T,
    ...
    function Pt(r) {
        return function(e, t) {
            "string" != typeof e && (t = e,
            e = "*");
            var i, n = 0, o = e.toLowerCase().match($) || [];
            if (y(t))
                for (; i = o[n++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
    ...
    S.extend({
        ...
        ajax: function(e, t) {
            ...
            e = void 0),
            t = t || {};
            var d, u, f, i, p, n, h, g, o, r, v = S.ajaxSetup({}, t), m = v.context || v, y = v.context && (m.nodeType || m.jquery) ? S(m) : S.event, b = S.Deferred(), w = S.Callbacks("once memory"), x = v.statusCode || {}, s = {}, a = {}, l = "canceled", _ = {
                readyState: 0,
    ...
    S.offset = {
        setOffset: function(e, t, i) {
            var n, o, r, s, a, l, c = S.css(e, "position"), d = S(e), u = {};
        ...
        return (c = c.map(function(e, t) {
            ...
            return e.reduce(function(e, t) {
                ...
                return function(e, t, i, n) {
                    var o, r = e.match(/((?:\-|\+)?\d*\.?\d*)(.*)/), s = +r[1], a = r[2];
                    if (!s)
                        return e;
                    if (0 !== a.indexOf("%"))
        ...
        modifiers: {
            ...
            flip: {
                ...
                fn: function(h, g) {
                    ...
                    return w.forEach(function(e, t) {
                        ...
                        m = h.placement.split("-")[0],
                        y = E(m);
                        var i, n = h.offsets.popper, o = h.offsets.reference, r = M, s = "left" === m && r(n.right) > r(o.left) || "right" === m && r(n.left) < r(o.right) || "top" === m && r(n.bottom) > r(o.top) || "bottom" === m && r(n.top) < r(o.bottom), a = r(n.left) < r(v.left), l = r(n.right) > r(v.right), c = r(n.top) < r(v.top), d = r(n.bottom) > r(v.bottom), u = "left" === m && a || "right" === m && l || "top" === m && c || "bottom" === m && d, f = -1 !== ["top", "bottom"].indexOf(m), p = !!g.flipVariations && (f && "start" === b && a || f && "end" === b && l || !f && "start" === b && c || !f && "end" === b && d);
                        (s || u || p) && (h.flipped = !0,
                        (s || u) && (m = w[t + 1]),
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s, a, l = void 0 === r ? t.gpuAcceleration : r, c = b(y(e.instance.popper)), d = {
                        position: o.position
                    }, u = {
                        left: M(o.left),
                        top: $(o.top),
                        bottom: $(o.bottom),
                        right: M(o.right)
                    }, f = "bottom" === i ? "top" : "bottom", p = "right" === n ? "left" : "right", h = D("transform");
...
function(e, t) {
        ...
        typeCheckConfig: function(e, t, i) {
            for (var n in i)
                if (Object.prototype.hasOwnProperty.call(i, n)) {
                    var o = i[n]
                      , r = t[n]
                      , s = r && Et.isElement(r) ? "element" : (a = r,
    ...
    M = function() {
        ...
        e._slide = function(e, t) {
            var i, n, o, r = this, s = this._element.querySelector($), a = this._getItemIndex(s), l = t || s && this._getItemByDirection(e, s), c = this._getItemIndex(l), d = Boolean(this._interval);
    ...
    fe = function() {
        ...
        c._dataApiKeydownHandler = function(e) {
            ...
            e.stopPropagation(),
            !this.disabled && !G(this).hasClass(re))) {
    ...
    pe(document).on(we.CLICK_DATA_API, '[data-toggle="modal"]', function(e) {
        var t, i = this, n = Ct.getSelectorFromElement(this);
    ...
    kt = function() {
        ...
        return e.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && gt(this._element).hasClass(wt) || gt(this._element).hasClass("disabled"))) {
                var e, n, t = gt(this._element).closest(".nav, .list-group")[0], o = Ct.getSelectorFromElement(this._element);
                if (t) {
...
jQuery(document).ready(function(s) {
    var e, r, a = 2500, l = 3800, c = l - 3e3, o = 50, d = 150, u = 500, f = u + 800, p = 600, n = 1500;
    function h(e) {
        var t = m(e);
...
function(P, e) {
    P.fn.drawDoughnutChart = function(b, e) {
        ...
        ;
        S.beforeDraw.call(n);
        var r, s = P('<svg width="' + t + '" height="' + i + '" viewBox="0 0 ' + t + " " + i + '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"></svg>').appendTo(n), E = [], a = {
            linear: function(e) {
                return e
            },
        ...
        }[S.animationEasing], C = (r = [i / 2, t / 2],
        Math.min.apply(null, r) - S.edgeOffset), A = C * (S.percentageInnerCutout / 100), O = 0, l = C + S.baseOffset, c = A - S.baseOffset;
...
function(s) {
    ...
    s.scrollIt = function(e) {
        ...
        s(window).on("scroll", function() {
            var e, i = s(window).scrollTop(), t = s("[data-scroll-index]").filter(function(e, t) {
...
function() {
    ...
    function T(e) {
        var t, i = e.config, n = e.styles.transform;
    ...
    function f(e) {
        var t, i, n, o, r, s, a, l, c, d = y(e.domEl), u = {
        ...
        }(e.config.container), p = e.config.viewFactor, h = d.height, g = d.width, v = d.top, m = d.left;
        return i = v + h * p,
        n = m + g * p,
        o = v + h - h * p,
        r = m + g - g * p,
    ...
    t.prototype.reveal = function(e, t, i, n) {
        ...
        o = x(t),
        u = o,
        !(r = "string" == typeof (d = e) ? Array.prototype.slice.call(u.querySelectorAll(d)) : E.tools.isNode(d) ? [d] : E.tools.isNodeList(d) ? Array.prototype.slice.call(d) : Array.isArray(d) ? d.filter(E.tools.isNode) : []).length)
            return E;
...
function(e, t) {
    ...
    var d, p, h, g = "object" == typeof window && window && window.Math == Math ? window : "object" == typeof self && self && self.Math == Math ? self : Function("return this")(), v = !u(function() {
        return 7 != Object.defineProperty({}, "a", {
            get: function() {
                return 7
            }
        }).a
    }), m = g.document, y = a(m) && a(m.createElement), x = !v && !u(function() {
    ...
    , N = function(t, i) {
    ...
    }, z = q("species"), B = {}.propertyIsEnumerable, U = Object.getOwnPropertyDescriptor, V = {
        f: U && !B.call({
            1: 2
        }, 1) ? function(e) {
            var t = U(this, e);
        ...
        return w(f(e))
    }, X = {}.hasOwnProperty, Q = function(e, t) {
        return X.call(e, t)
    }, K = Object.getOwnPropertyDescriptor, G = {
        f: v ? K : function(e, t) {
            if (e = Y(e),
            t = _(t, !0),
            x)
    ...
    }, Z = L("native-function-to-string", Function.toString), J = g.WeakMap, ee = "function" == typeof J && /native code/.test(Z.call(J)), te = L("keys"), ie = {}, ne = g.WeakMap;
    if (ee) {
        var oe = new ne
          , re = oe.get
          , se = oe.has
    ...
    var ce = {
      ...
      , pe = (!1,
    function(e, t, i) {
        var n, o, r = Y(e), s = E(r.length), a = (n = s,
      ...
      , Oe = G.f
      , De = function(e, t) {
        var i, n, o, r, s, a = e.target, l = e.global, c = e.stat;
        if (i = l ? g : c ? g[a] || N(a, {}) : (g[a] || {}).prototype)
            for (n in t) {
                if (r = t[n],
                o = e.noTargetGet ? (s = Oe(i, n)) && s.value : i[n],
                !Ae(l ? n : a + (c ? "." : "#") + n, e.forced) && void 0 !== o) {
    ...
    var Ke, Ge, Ze = RegExp.prototype.exec, Je = String.prototype.replace, et = Ze, tt = (Ke = /a/,
    Ge = /b*/g,
    Ze.call(Ke, "a"),
    Ze.call(Ge, "a"),
    0 !== Ke.lastIndex || 0 !== Ge.lastIndex), it = void 0 !== /()??/.exec("")[1];
    (tt || it) && (et = function(e) {
        var t, i, n, o;
    ...
    var Mt = function(e, t, i) {
        ...
        function(n, o, e) {
            var r, s, i, a, l, c, d = 0, u = !1, f = !1, t = !0;
    ...
    var Xi = void 0 !== Di.ResizeObserver ? Di.ResizeObserver : Yi
      ...
      , Ki = function() {
        ...
        e.getScrollbarSize = function(e) {
            void 0 === e && (e = "y");
            var t, i = this.scrollbarWidth ? this.contentWrapperEl[this.axis[e].scrollSizeAttr] : this.contentWrapperEl[this.axis[e].scrollSizeAttr] - this.minScrollbarWidth, n = this.axis[e].track.rect[this.axis[e].sizeAttr];
        ...
        venobox: function(e) {
            ...
            this.each(function() {
                ...
                function t() {
                    ...
                    !0 === H ? T.show() : T.hide(),
                    "" !== R ? S.show() : S.hide(),
                    U = z.length || !0 === j ? (x(".vbox-next").css("display", "block"),
                    !0) : (x(".vbox-next").css("display", "none"),
                    !1),
                    !0 !== (V = 0 < $.index(K) || !0 === j ? (x(".vbox-prev").css("display", "block"),
                    !0) : (x(".vbox-prev").css("display", "none"),
                    !1)) && !0 !== U || (A.on(l.DOWN, r),
                    A.on(l.MOVE, s),
                    A.on(l.UP, a))
                }
                ...
                function h(e) {
                    var t, i, n = (O.match(/(http:|https:|)\/\/(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/),
                    -1 < RegExp.$3.indexOf("youtu") ? i = "youtube" : -1 < RegExp.$3.indexOf("vimeo") && (i = "vimeo"),
                    {
                        type: i,
                        id: RegExp.$6
